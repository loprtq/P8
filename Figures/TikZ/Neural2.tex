...
\begin{tikzpicture}[x=2cm,y=1.5cm]
  ...
  \node[] at (1-0.25,1.45) {\contour{white}{$w_{1,0}^{(1)}$}};
  ...
  \node[] at (1.75,1.45) {\contour{white}{$w_{1,0}^{(2)}$}};
  ...
  \node[] at (2.75,1.45) {\contour{white}{$w_{1,0}^{(3)}$}};
  ...
  \node[] at (3.55,1.44) {\contour{white}{$w_{1,0}^{(4)}$}};
